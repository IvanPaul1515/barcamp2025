...
export const eventos: Evento[] = [
  ...
  // 10:30 - 11:30
  {
    ...
    detalles:
      'En un mundo donde la conectividad no siempre está garantizada, diseñar aplicaciones que funcionen sin internet ya no es opcional, es una necesidad.En esta charla exploraremos cómo construir apps resilientes con Flutter aplicando el enfoque Offline First. Veremos cómo integrar bases de datos locales, sincronización con la nube y patrones de arquitectura moderna, asegurando aplicaciones escalables, robustas y fáciles de mantener.',
  ...
  },
  {
    ...
    detalles:
      'Si alguna vez tuviste el deseo de aprender a programar videojuegos para una de tus consolas retro favoritas. Ven y únete a esta charla y aprende a desarrollar videojuegos retro de una vez por todas. En nuestra charla abordaremos distintas herramientas disponibles para desarrollar videojuegos, también como instalar dichas herramientas, ejecutar ejemplos prácticos y una guía paso a paso sobre cómo ir de una ventana vacía hasta tener nuestro primer juego.',
    lugar: 'Sala #2, Padre Arroyo',
  },
  {
    horario: '11:30 - 12:30',
  ...
  },
  {
    ...
    detalles:
      'En esta charla teórico–práctica exploraremos cómo combinar Inteligencia Artificial con análisis de datos en Power BI para transformar información cruda en decisiones inteligentes.\n' +
      '\n' +
  ...
  },
  {
    ...
    detalles:
      'Con esta charla aprenderás cómo reducir el drama de pasar a producción con una mezcla de buenas prácticas, herramientas y hacks que realmente funcionan. Compartiré mis experiencias reales —desde e-commerce hasta banca— sobre lo que aprendí cuando los despliegues salieron mal (y cómo evitar repetir la historia). Veremos patrones simples, estrategias de rollback, chequeos previos y cultura de equipo para que tus releases sean más predecibles y menos traumáticos.\n' +
      '\n' +
  ...
  },
  {
    ...
    etiquetas: ['wasm', 'web'],
    detalles:
      '¿Sabe cuál es el principal desafío en el desarrollo de software moderno? Hacer que sistemas construidos con diferentes lenguajes trabajen juntos.\n' +
      '\n' +
  ...
  // 15:00 - 16:00
  {
    ...
    detalles:
      'Cómo y por qué migramos una aplicación móvil de una empresa Fintech de 100 millones de dólares de React Native a Flutter en tan solo unas semanas utilizando IA.',
    lugar: 'Sala #1, Padre Arroyo',
  },
  {
    horario: '15:00 - 16:00',
    ...
    detalles:
      'a arquitectura de software va mucho más allá de dibujar diagramas: es el arte de tomar decisiones que impactan la escalabilidad, la seguridad, los costos y la vida diaria de los equipos. En esta charla exploraremos patrones reales (monolitos, microservicios, hexagonal, event-driven), los errores más comunes y cómo enfrentarlos sin caer en modas pasajeras.\n' +
      '\n' +
  ...
  {
    horario: '15:00 - 16:00',
    actividad: "Ten things we've learned from running production infrastructure at Google ",
    ponente: 'Oscar J Rodriguez',
    etiquetas: ['google'],
    detalles:
      'Esta presentación comparte diez lecciones aprendidas al administrar la infraestructura de producción de Google.\n' +
      '\n' +
  ...
  },
  {
    ...
    detalles:
      'Esta es una actualización de una charla que habíamos realizados anteriormente donde mostramos como realizar pruebas integrales para los servicios REST utilizando Assured, una librería Java para la validación de servicios REST.\n' +
      '\n' +
  ...
  // 16:00 - 17:00
  {
    ...
    detalles:
      'Cuando pensamos en startups tecnológicas, la narrativa suele estar dominada por los unicornios y las grandes corporaciones que transformaron industrias enteras. Sin embargo, la realidad es que la mayoría de los emprendimientos no llegan a ser el próximo Amazon, Apple o Google. Y eso no significa fracaso.\n' +
      '\n' +
  ...
  {
    horario: '16:00 - 17:00',
    actividad: 'Sin cultura de datos no hay transformacion digital',
    ponente: 'Emmanuel de la Rosa',
    etiquetas: ['datos', 'transformacion', 'SQL', 'BI'],
    detalles:
      'Sin cultura de datos no hay transformación digital.\n' +
      '\n' +
  ...
  },
  {
    ...
    detalles:
      '​Descubre el camino evolutivo de Java a través de sus versiones y cómo sigue siendo la columna vertebral de soluciones robustas y modernas. ¡Una inyección de know-how esencial para todo desarrollador!',
    lugar: 'Sala #4, Padre Arroyo',
  },
  ...
  {
    horario: '17:00 - 18:00',
    actividad: 'CIBERSEGURIDAD EN EL\n' +
        'DESARROLLO DE\n' +
        'SOFTWARE: AMENAZAS\n' +
        'LOCALES y PRÁCTICAS\n' +
        'MODERNAS PARA\n' +
        'PROGRAMADORES',
    ponente: 'Carlos Camacho, Freddy Peña, Karla Aquino, Rafael Dorville',
    etiquetas: ['panel', 'cierre','CIBERSEGURIDAD'],
    detalles: '',
    lugar: 'Teatro',
  },
]
